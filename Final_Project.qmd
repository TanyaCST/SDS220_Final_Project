...
To investigate whether the initial total price (the sum of starting price and shipping price) equals to the dealing price, we need to conduct a two sample mean T test. Before starting hypothesis testing, we need to bring out null hypothesis and alternative hypothesis of our research question. Our null hypothesis for the hypothesis testing is that there is no difference between the initial total price and the dealing price. Our alternative hypothesis is that there is a difference between the initial total price and the dealing price of Mario Kart. In symbols: 
$$H_0: \mu_{diff} = 0$$ 
$$H_A: \mu_{diff} \ne 0$$
To investigate whether our null hypothesis is true, we need to conduct a **Two Sample T Test**. A two sample T test is 
